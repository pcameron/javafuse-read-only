...
bot.events.newMouseEvent_ = function(a, b, c) {
  ...
  goog.userAgent.IE && !d.createEvent ? (d = d.createEventObject(), d.altKey = k, d.controlKey = m, d.metaKey = n, d.shiftKey = l, d.clientX = f, d.clientY = g, d.button = h, b == goog.events.EventType.MOUSEOUT ? (d.fromElement = a, d.toElement = c.related || null) : b == goog.events.EventType.MOUSEOVER ? (d.fromElement = c.related || null, d.toElement = a) : (d.fromElement = null, d.toElement = null)) : (d = d.createEvent("MouseEvents"), d.initMouseEvent(b, i, !0, e, 1, 0, 0, f, g, m, k, l, n, h, 
  j));
  return d
};
bot.events.newKeyEvent_ = function(a, b, c) {
  ...
  if(goog.userAgent.GECKO) {
    ...
    if(goog.userAgent.IE && !d.createEvent) {
...
bot.events.newHtmlEvent_ = function(a, b, c) {
  ...
  a.fireEvent && d && d.createEventObject && !d.createEvent ? (a = d.createEventObject(), a.altKey = f, a.ctrl = g, a.metaKey = e, a.shiftKey = h) : (a = d.createEvent("HTMLEvents"), a.initEvent(b, c, !0), a.shiftKey = h, a.metaKey = e, a.altKey = f, a.ctrlKey = g);
  return a
};
...
bot.events.fire = function(a, b, c) {
  ...
  return goog.userAgent.IE && !a.dispatchEvent ? a.fireEvent("on" + b, c) : a.dispatchEvent(c)
};
